...
; (gfx1250 wave32 -> gfx942 wave64).  row_mirror reverses lanes within
; a 16-lane row: lane i reads from lane 15 - i.  The rewrite computes
; srcWithinRow = 15 - withinRow, which stays within [0, 15] and is
; always in-range.
...
; CHECK-DAG: %mirror_src = sub i32 15, %cwd_dpp_within_row
; CHECK-DAG: %cwd_dpp_src_safe = select i1 true, i32 %mirror_src, i32 0
