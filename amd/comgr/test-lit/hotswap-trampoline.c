...
// COM:
// COM: Inputs are compiled with %clang directly (not Comgr actions) and piped
// COM: through the canonical hotswap-rewrite driver.
...
// RUN: %clang -x assembler -target amdgcn-amd-amdhsa -mcpu=gfx1250 \
// RUN:   -c %t1.s -o %t1.o
// RUN: %clang -target amdgcn-amd-amdhsa -mcpu=gfx1250 -nogpulib \
// RUN:   %t1.o -o %t1.elf

// RUN: hotswap-rewrite %t1.elf \
// RUN:   amdgcn-amd-amdhsa--gfx1250 amdgcn-amd-amdhsa--gfx1250 \
// RUN:   --dump %t1.out.elf --check-idempotent \
...
// COM: Two single-address ds_load_b32 instructions should appear (in trampoline)
...
// RUN: hotswap-rewrite %t2.elf \
// RUN:   amdgcn-amd-amdhsa--gfx1250 amdgcn-amd-amdhsa--gfx1250 \
// RUN:   --dump %t2.out.elf --check-idempotent \
...
// RUN: hotswap-rewrite %t3.elf \
// RUN:   amdgcn-amd-amdhsa--gfx1250 amdgcn-amd-amdhsa--gfx1250 \
// RUN:   --dump %t3.out.elf --check-idempotent \
